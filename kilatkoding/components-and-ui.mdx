...
description: "Pahami sistem UI KilatKoding, komponen yang tersedia, dan area yang paling sering Anda ubah saat rebranding."
mode: "wide"
---
...
## Dua jenis komponen yang perlu Anda kenal
...
Preset ini berguna kalau Anda ingin:
...
## File yang biasanya Anda ubah saat mengubah UI
...
<Tip>
Kalau Anda ingin hasil visual yang cepat tetapi tetap konsisten, mulai dari preset marketing lalu lanjutkan ke token CSS global.
</Tip>
