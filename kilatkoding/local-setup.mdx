...
<AccordionGroup>
  <Accordion title="Windows">
    ...
    Setelah selesai, tutup lalu buka ulang terminal Anda. Pastikan kedua command ini berhasil:
  ...
  <Accordion title="Linux">
    Contoh berikut memakai Ubuntu atau Debian. Jika distro Anda berbeda, gunakan package manager setara.
...
<Steps>
  <Step title="Ambil source code">
    Jika Anda menerima akses repo, clone repo tersebut. Jika Anda menerima ZIP, ekstrak ke folder kerja Anda.
...
## Kalau Anda juga ingin menjalankan E2E test
...
## Tanda setup lokal Anda berhasil

| Yang dicek | Hasil yang diharapkan |
| --- | --- |
| `npm run env:check` | Tidak ada error fatal untuk fitur yang Anda aktifkan |
