...
Gunakan contoh ini kalau Anda hanya ingin auth, dashboard, dan satu payment provider:
...
<Tip>
Kalau sebuah fitur memang belum Anda pakai, lebih baik matikan lewat toggle daripada membiarkannya aktif tanpa konfigurasi.
</Tip>
