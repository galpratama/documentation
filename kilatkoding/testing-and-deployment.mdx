...
Repo ini paling natural untuk Vercel karena memakai Next.js App Router, tetapi tidak terkunci ke Vercel. Apa pun platformnya, Anda tetap perlu:
...
<Tip>
Kalau Anda menyalakan hanya sebagian fitur, test dan health check Anda juga harus fokus ke fitur yang memang aktif. Jangan mengejar status sempurna untuk fitur yang sengaja dimatikan.
</Tip>
