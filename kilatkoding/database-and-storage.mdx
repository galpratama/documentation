...
Kalau Anda tidak memakai Supabase CLI, Anda bisa menyalin file SQL ke SQL editor Supabase secara berurutan.
...
Lakukan ini setelah migrasi live Anda benar-benar sudah sesuai.

<Tip>
Kalau billing, admin, avatar, atau webhook terasa tidak konsisten, cek dulu apakah semua migrasi sudah benar-benar terpasang di project Supabase Anda.
</Tip>
