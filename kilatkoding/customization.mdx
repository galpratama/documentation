...
| Yang ingin Anda ubah | File utama | Dampak |
| --- | --- | --- |
...
<Steps>
  ...
  <Step title="Tinjau dashboard dan admin">
    Pastikan data, istilah, dan CTA di dashboard cocok dengan produk Anda.
  </Step>
</Steps>
...
## Kalau Anda ingin mematikan fitur
...
- Anda bisa mengaktifkan fitur lagi tanpa restore banyak file.
