...
5. [What you can do without code vs what needs a developer](/en/kilatkoding/no-code-vs-developer)
6. [Launch checklists](/en/kilatkoding/launch-checklists)
...
3. [Local setup](/en/kilatkoding/local-setup)
4. [Services setup](/en/kilatkoding/services-setup)
5. [Environment variables](/en/kilatkoding/environment-variables)
6. [Vercel deployment](/en/kilatkoding/vercel-deployment)
